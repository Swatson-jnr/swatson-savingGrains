        ...
        >
          <div className="flex min-h-full">
            ...
            <div className="flex max-h-[987px] flex-col rounded-l-2xl rounded-bl-2xl self-stretch border-r border-[#E7B00E] bg-[#FDFEF5] px-7 py-9">
              <div className="mb-9">
                <Title text="Move Stock" weight="bold" level={4} />
            ...
            <div className="relative flex flex-1 flex-col px-10 pt-14 pb-6 bg-white">
              {currentStep === 1 && (
                <>
                  <div>
                    <button
                ...
                <>
                  <div className="relative h-80">
                    ...
                    <div className="relative w-full rounded-xl bg-white shadow-xl py-6 px-10">
                      ...
                      <MoveStockConfirmationDetails details={details} />
